...
const TaskViewKanban = ({data, showKanbanTaskView, setShowKanbanTaskView}: any) => {
...
const handleOkk = () => {
  ...
  return (
    <Modal className='TaskViewModal' open={showKanbanTaskView} onOk={handleOkk} onCancel={handleCancell}>
