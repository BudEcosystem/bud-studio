...
function WorkspaceMenuItem({
  ...
  const handleOnMenuClick = (e:any,color: any, name: any, index:number): any => {
...
function MenuWorkSpaceInput({menu, updateWorkspace,index}:any){
    ...
    icon={
        ...
        <input type='text' placeholder='Enter space name' onBlur={onBlurHandler} value={workSpace.name} onKeyUp={workSpaceNameChangeHandler} onInput={workSpaceNameInputHandler} className={classWrksps.workspaceTextBox}/>
    </Menu.Item>
}