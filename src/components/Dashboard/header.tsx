    ...
    const  FolderIcon = ({themeColor}: any) => {
      return (
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M0 2.55139H14.285C14.7351 2.55139 15.1 2.91626 15.1 3.36634V11.1852C15.1 11.6353 14.7351 12.0001 14.285 12.0001H0.814949C0.364865 12.0001 0 11.6353 0 11.1852V2.55139Z" fill="#7B8388" stroke="#7B8388" stroke-width="2" mask="url(#path-1-inside-1_1076_1233)"/>
