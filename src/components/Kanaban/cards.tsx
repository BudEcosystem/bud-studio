const KanbanCards = ({ hasSubTask, messagePassed }) => {
  return (
    <div draggable={true} style={{ display: "flex", flexDirection: "column" }} className="draggable">
      <div className="kanban-each-section-div-body">
        ...
        {messagePassed && <div className="card-details">All the details are in the file,I'm sure it will turn out cool</div>}
